...
import 'form_curriculo_model.dart';
export 'form_curriculo_model.dart';

class FormCurriculoWidget extends StatefulWidget {
  const FormCurriculoWidget({super.key});

  @override
  State<FormCurriculoWidget> createState() => _FormCurriculoWidgetState();
}

class _FormCurriculoWidgetState extends State<FormCurriculoWidget> {
  late FormCurriculoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FormCurriculoModel());

    _model.nomeCurriculoTextController ??= TextEditingController();
    _model.nomeCurriculoFocusNode ??= FocusNode();

    _model.descCurriculoTextController ??= TextEditingController();
    ...
    _model.habilidadeCurriculoTextController ??= TextEditingController();
    _model.habilidadeCurriculoFocusNode ??= FocusNode();

    _model.certificacaoCurriculoTextController ??= TextEditingController();
    _model.certificacaoCurriculoFocusNode ??= FocusNode();

    _model.idiomaCurriculoTextController ??= TextEditingController();
                                  ...
                                  onPressed: () async {
                                    await CurriculoTable().insert({
                                      ...
                                      'formacaoAcademica_Curriculo': _model
                                          .formacaoCurriculoTextController.text,
                                      'habilidades': _model
                                          .habilidadeCurriculoTextController
                                          .text,
                                      ...
                                      'userId': checkoutBottomSheet2PessoasRow
                                          ?.userId,
                                    });
                                    context.safePop();
                                  },
